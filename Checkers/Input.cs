...
namespace Checkers
{
    public struct Input
    {
        static KeyboardState currentKeyboard, lastKeyboard;
        ...
        public static Vector2 mouseDeltaMovement()
        {
            Vector2 delta = new Vector2(lastMouse.X - currentMouse.X, lastMouse.Y - currentMouse.Y);
        ...
        {
            return lastMouse.ScrollWheelValue - currentMouse.ScrollWheelValue;
        }
